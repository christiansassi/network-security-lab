...
def topology():
    ...
    info("*** Creating nodes\n")
    ap1 = net.addStation('ap1', mac='02:00:00:00:01:00', position='40,40,0')
    sta1 = net.addStation('sta1', ip='192.168.100.100/24', position='0,0,0')
    ...
    makeTerm(ap1, title='AP', cmd="bash -c 'source ../../krackattacks-scripts/krackattack/venv/bin/activate && python ../../krackattacks-scripts/krackattack/krack-test-client.py;'")
