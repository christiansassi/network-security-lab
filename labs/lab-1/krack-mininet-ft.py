...
def topology():
    ...
    makeTerm(sta1, title='KrackAttack', cmd="bash -c 'source ../../krackattacks-scripts/krackattack/venv/bin/activate && python ../../krackattacks-scripts/krackattack/krack-ft-test.py wpa_supplicant -D nl80211 -i sta1-wlan0 -c ../../sta1-wlan0_0.staconf;'")
